...
//                  and has the stars Michael Jordan, Michael Jordan, and Michael Jordan (array of strings)
var spaceJam={
title: "Space Jam",
release_year: 1996,
...
{
  if(key.slice(0,6)==="former") delete anakinSkywalker[key]
}
...
function whoAmI(obj)
{
 if(!obj.name) return 'has amnesia'
